...
static void print_usage(std::ostream& os, const char* app) {
    os << "Usage:\n"
       ...
       << "  --runtime_policy    0|1      Setup runtime policy for session (mem/cpus binding + app OpenCV "
       ...
       << "  " << app << " --mode face --model scrfd.onnx --image img.jpg --threads_intra 2 --threads_inter 1\n"
       << "  " << app
